...
const reviews = [
  { name: "Lucky B.", text: "Very friendly doctor, explains clearly even to non-educated patients. I felt very comfortable during my visit.", rating: 5 },
  { name: "Lucky B.", text: "Best skin doctor in Narasaraopet with fast recovery. My acne cleared up in just 3 weeks!", rating: 5 },
  { name: "Lucky D.", text: "Excellent results for acne and spots. Dr. Lucky really listens and gives the right treatment.", rating: 5 },
  { name: "Lucky M.", text: "Very professional clinic, clean environment. My skin allergy was treated quickly. Highly recommend!", rating: 4 }];
